    ...
    <div className="min-h-screen bg-[#070b14] text-gray-100 flex flex-col selection:bg-sky-500 selection:text-black">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10">
        ...
        <header className="mb-8 md:mb-10 border-b border-white/10 pb-8">
          ...
          {showtimes.length > 0 && (
            <p className="text-sm sm:text-base text-gray-400 mt-3 flex items-center gap-2 flex-wrap">
              <span className="inline-flex items-center gap-1.5 text-gray-300">
                <svg className="w-4 h-4 text-sky-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                {new Date(showtimes[0].start_time).toLocaleDateString("vi-VN")}
              </span>
              ...
              <span className="inline-flex items-center gap-1.5 text-gray-300">
                ...
                {new Date(showtimes[0].start_time).toLocaleTimeString("vi-VN", {
                  hour: "2-digit",
                  minute: "2-digit",
                })}{" "}
                -{" "}
                {new Date(showtimes[0].end_time).toLocaleTimeString("vi-VN", {
                  hour: "2-digit",
                  minute: "2-digit",
                })}
              </span>
